...
import com.ramsarup.ramsarup.Adapter.Shayriadapter;
 ...
 */
public class Shayri extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Shayri");
...
// Inflate the layout for this fragment
        recyclerView = view.findViewById(R.id.recyclershayri);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_shayri, container, false);
    ...
    public void setvalue(){
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Shayriadapter adapter = new Shayriadapter(itemList, getContext());
                    itemList.add(data);
