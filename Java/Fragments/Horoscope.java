...
import com.ramsarup.ramsarup.Adapter.Horoscopeadapter;
...
public class Horoscope extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Horoscope");
...
// Inflate the layout for this fragment
        recyclerView = view.findViewById(R.id.recyclerhoroscope);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_horoscope, container, false);
    ...
    public void setvalue(){
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Horoscopeadapter adapter = new Horoscopeadapter(itemList, getContext());
                    itemList.add(data);
