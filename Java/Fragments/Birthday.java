...
import com.ramsarup.ramsarup.Adapter.Birthdayadapter;
...
public class Birthday extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Birthday");
...
// Inflate the layout for this fragment
        recyclerView = view.findViewById(R.id.recyclerbirthday);
    ...
    public void setvalue(){
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Birthdayadapter adapter = new Birthdayadapter(itemList, getContext());
                    itemList.add(data);
