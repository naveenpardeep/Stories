...
import com.ramsarup.ramsarup.Adapter.Gharelunuskheadapter;
 ...
 */
public class Gharelunuskhe extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Gharelunuskhe");
    private List<Item> itemList = new ArrayList<>();



    public Gharelunuskhe() {
...
// Inflate the layout for this fragment
        recyclerView = view.findViewById(R.id.recyclergharelu);
        gharelu = view.findViewById(R.id.gharelunuskhe);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_gharelunuskhe, container, false);
    ...
    public void setvalue(){
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Gharelunuskheadapter adapter = new Gharelunuskheadapter(itemList, getContext());
                    itemList.add(data);
