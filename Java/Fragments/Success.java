...
import com.ramsarup.ramsarup.Adapter.Successadapter;
...
public class Success extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Successstories");
...
// Inflate the layout for this fragment
        recyclerView = view.findViewById(R.id.recyclersuccess);
    ...
    itemList.clear();
        dbref.addChildEventListener(new ChildEventListener() {
            final Successadapter adapter = new Successadapter(itemList, getContext());
