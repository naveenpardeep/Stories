...
import com.ramsarup.ramsarup.Adapter.Factsadapter;
...
public class Facts extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Facts");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerfacts);
    ...
    public void setvalue(){
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Factsadapter adapter = new Factsadapter(itemList, getContext());
