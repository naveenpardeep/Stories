...
import com.ramsarup.ramsarup.Adapter.Jokesadpater;
...
public class Jokes extends Fragment {
    ...
    DatabaseReference dbref = database.getReference("Jokes");
...
// Inflate the layout for this fragment
        ...
        jokes = view.findViewById(R.id.jokes);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_jokes, container, false);
...
itemList.clear();
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                {
                    final Jokesadpater adapter = new Jokesadpater(itemList, getContext());
                    itemList.add(data);
