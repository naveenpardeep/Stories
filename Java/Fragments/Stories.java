...
import com.ramsarup.ramsarup.Adapter.Storiesadapter;
...
ImageView go;
    ...
    DatabaseReference dbref = database.getReference("Stories");
...
// Inflate the layout for this fragment
        ...
        storyheading = view.findViewById(R.id.storyheading);
    ...
    public void setvalue(){
        itemList.clear();   dbref.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Item data = dataSnapshot.getValue(Item.class);
                {
                    final Storiesadapter adapter = new Storiesadapter(itemList, getContext());
                    itemList.add(data);
